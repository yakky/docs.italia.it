...
router.register(r'command', BuildCommandViewSet, base_name='command')
...
router.register(r'remote/org', RemoteOrganizationViewSet, base_name='remote/org')
router.register(r'remote/repo', RemoteRepositoryViewSet, base_name='remote/repo')
